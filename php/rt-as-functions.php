...
function rtas_bp_validate($errors) {
	global $bp;
        $strError = __('Please check the CAPTCHA code. It\'s not correct.');
	if (function_exists('recaptcha_check_answer')) {
		$response = recaptcha_check_answer(RTAS_PRIVATE_KEY, $_SERVER['REMOTE_ADDR'], $_POST['recaptcha_challenge_field'], $_POST['recaptcha_response_field']);
